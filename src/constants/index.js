...
export const MISSION_OFFER = [
  ...
  },
  {
    ...
    title: "What We Offer",
    description:
      "As a one-stop shop for horticultural products, SOUK Farms offers a diverse range of fresh produce. Our portfolio includes fine beans, chillies, avocadoes, sugar snaps, snow peas, Tenderstem broccoli, and more, each cultivated with the utmost care and attention to quality. Operating on over 500 hectares of lush farmland across Rwanda, we have the capacity to meet high-volume demands while ensuring consistent quality.",
  }
];
