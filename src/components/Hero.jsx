  ...
  return (
    <section className="max-w-full mx-auto bottomBorder">
      <div className="flex flex-col items-center my-5">
        ...
        className="lg:mt-6 text-center px-2 text-sm mb-4 font-medium tracking-tight bg-gradient-to-r from-[#3d5f4e] via-[#96f4b5] to-[#3d5f4e] bg-clip-text text-transparent">
